...
var map=new maplibregl.Map({container:'map',style:{version:8,glyphs:GLYPH_URL,
  ...
  layers:[
    ...
    lyr('fstrail','fstrail','#2585D8',w(1.4,3.4,8)),
    lyr('trail50','trail50','#2585D8',w(1.5,3.7,8.6)),
    lyr('mccct','mccct','#1C1A16',w(1.5,3.7,8.6)),
    lyr('moto24','moto24','#1C1A16',w(1.5,3.7,8.6)),
    ...
    {id:'show-line',type:'line',source:'showonly',minzoom:11.5,
      ...
      paint:{'line-color':['match',['get','c'],
          'foot','#7CB342','horse','#8E6BB5','snow','#4FB3C9',
          'snowmob','#4FB3C9','nfsmoto','#C98A2E','#7C6F5A'],
...
var ACTS=[
  {k:'all',  h:'All routes',        sw:'#2585D8'},
  {k:'orv',  h:'ORV / dirt bike',   sw:'#2585D8', cls:['route72','trail50','moto24','mccct','fstrail']},
  {k:'dirt', h:'Two-track',         sw:'#A9702F', cls:['track']},
  {k:'foot', h:'Hiking',            sw:'#7CB342', cls:['foot'], dash:1},
  {k:'horse',h:'Equestrian',        sw:'#8E6BB5', cls:['horse'], dash:1},
  {k:'snow', h:'Snowmobile / ski',  sw:'#4FB3C9', cls:['snow','snowmob'], dash:1},
  {k:'nfs',  h:'NFS trails',        sw:'#C98A2E', cls:['nfsmoto'], dash:1}
];
...
function buildActPanel(){
  ...
  p.innerHTML=ACTS.map(function(a){
    return '<button class="actrow'+(a.k===act?' on':'')+'" data-k="'+a.k+'">'+
